...
Description: Add a Compass (Text Legacy) for your Unity Projects
...
a basic "TestStuff_Controller" simply for testing purposes in case say the user 
...
2.A) Inside "Compass", create a UI: -> "Text (Legacy)" and rename it 
     to: "Compass Degree Text (Legacy)" *
...
5.A) Go back to: UI -> Canvas - Compass
     ...
     Add component / script: "DWG_Compass_Legacy.cs"

5.B) Ok, now fill out the related settings:

For -> DWG_Compass_Legacy (Script):
-----------------------------------
...
----------------------------------------------------------------------------------------
Compass Degree Text (Legacy) (Text):
----------------------------------------------------------------------------------------
...
C) Go into "Cursor" and create "RawImage" & name it: "Cursor Image"
