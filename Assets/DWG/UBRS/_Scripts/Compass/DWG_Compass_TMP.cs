...
namespace DWG.UBRS.DWG_Compass_TMP
{
    ...
    public class DWG_Compass_TMP : MonoBehaviour
    {
        ...
        // Public - TMP_Text - CompassDirection - Text
        public TMP_Text CompassDirection;
        ...
        public void Update()
        {
            ...
            if (CompassEnabled == true)
            {
                ...
                Debug.Log("The (TMP Text) Compass is enabled.");
            ...
            else if (CompassEnabled == false) 
            {
                ...
                // Compass IMG - Image - gameObject - SetActive - False
